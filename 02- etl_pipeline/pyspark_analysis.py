...
spark = SparkSession.builder \
    ...
    .config("spark.jars", "/mnt/d/library_management_db - ETL/mysql-connector-j-9.7.0/mysql-connector-j-9.7.0/mysql-connector-j-9.7.0.jar") \
    .getOrCreate()

print("Spark Session started!")

# Database connection properties
url = "jdbc:mysql://172.18.240.1:3306/library_db"
properties = {
    "user": "root",
    "password": "root123",
